  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <h3 className="display mt-2 text-xl leading-tight text-ink transition-colors group-hover:text-[#1f6f96]">
          {post.title}
        </h3>
        <p className="mt-3 text-sm leading-relaxed text-ink-soft line-clamp-3">{post.excerpt}</p>
        <span className="mt-5 inline-flex items-center text-[0.72rem] font-semibold uppercase tracking-[0.14em] text-[#1f6f96]">
          Read more →
        </span>
      </div>
    </Link>
