...
/** Fixed WhatsApp call-to-action in the bottom-right corner, on every page. */
export default function FloatingWhatsApp() {
  const message = encodeURIComponent(
    "Hi HUX EXPED! I'd like to know more about your treks.",
  );
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_14px_34px_-8px_rgba(37,211,102,0.7)] transition-transform duration-300 hover:scale-110 sm:bottom-7 sm:right-7"
    >
